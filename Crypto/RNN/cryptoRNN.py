...
for ratio in ratios:
    dataset = f"/Users/calum/Developer/Stock Analysis/Crypto/RNN/crypto_data/{ratio}.csv"
...
checkpoint = ModelCheckpoint('/Users/calum/Developer/Stock Analysis/Crypto/models/{}.model'.format(filepath), moniter='val_accuracy', verbose=1, save_best_only=True, mode='max')
